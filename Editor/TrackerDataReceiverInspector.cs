...
namespace SangoUtils.HTCViveTrackerHelpers
{
    ...
    internal class TrackerDataReceiverInspector : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            bool isGetTrackerDataBoolValue = EditorGUILayout.BeginToggleGroup("Get Tracker Data", _isGetTrackerDataToggle.boolValue);
            EditorGUILayout.Space();
            ...
            {
                _isGetTrackerDataToggle.boolValue = isGetTrackerDataBoolValue;
