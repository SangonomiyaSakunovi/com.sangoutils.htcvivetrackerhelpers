...
namespace SangoUtils.HTCViveTrackerHelpers
{
    ...
    internal class WebCameraUGUIInspector : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            bool isWebCameraViewToggleBoolValue = EditorGUILayout.BeginToggleGroup("Web Camera View", _isWebCameraViewToggle.boolValue);
            EditorGUILayout.Space();
            ...
            {
                _isWebCameraViewToggle.boolValue = isWebCameraViewToggleBoolValue;
